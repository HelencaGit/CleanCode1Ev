...
public class Persona {
    ...
    public Persona(String nombre, String apellido1, String apellido2, int edad, char sexo, Numero dni, String pais) {
        this.nombre = nombre;
    ...
    public void setDni(Numero dni) {
        this.dni = dni;
    }

    public Estudiar getEstudiar() {
        return estudiar;
    }
